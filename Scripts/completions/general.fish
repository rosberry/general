...
complete -c general -n '__fish_general_using_command general' -f -a 'plugin' -d 'Specifies onperations for plugins'
complete -c general -n '__fish_general_using_command general' -f -a 'config' -d 'Provides an access to config file'
...
complete -c general -n '__fish_general_using_command general plugin' -f -a 'add' -d 'Adds plugin from repo'
complete -c general -n '__fish_general_using_command general plugin' -f -a 'activate' -d 'Activates installed plugin'
complete -c general -n '__fish_general_using_command general plugin' -f -a 'help' -d 'Show subcommand help information.'
complete -c general -n '__fish_general_using_command general plugin add' -f -r -l path -s p -d 'The path to the plugin binary that should be installed'
complete -c general -n '__fish_general_using_command general plugin add --path' -f -a '(__fish_complete_directories)'
complete -c general -n '__fish_general_using_command general plugin add -p' -f -a '(__fish_complete_directories)'
complete -c general -n '__fish_general_using_command general config' -f -a 'print' -d 'Displays content of .config file'
complete -c general -n '__fish_general_using_command general config' -f -a 'reset' -d 'Sets .config file to its default value'
